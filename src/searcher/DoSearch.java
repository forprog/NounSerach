...
public class DoSearch {
	...
	public static void main(String[] args) throws IOException {
		...
		wordSearcher.searchConditions.add(new SearchCondition(SearchConditionKind.ENTRY_PLACE,"î",3));
		wordSearcher.searchConditions.add(new SearchCondition(SearchConditionKind.ENTRY_PLACE,"ç",0));
		wordSearcher.searchConditions.add(new SearchCondition(SearchConditionKind.ENTRY_PLACE,"à",1));
		//wordSearcher.searchConditions.add(new SearchCondition(SearchConditionKind.IS_ENTRY_EXCEPT_PLACE,"à",0));
		...
		wordSearcher.searchConditions.add(new SearchCondition(SearchConditionKind.NO_ENTRY,"í",3));
